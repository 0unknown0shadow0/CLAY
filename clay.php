...
echo "                  \e[1;34m $$ |  $$\ $$ |      $$ |  $$ |    $$ |   \r\n";
echo "                  \e[1;34m \\$$$$$$  |$$$$$$$$\ $$ |  $$ |    $$ |\r\n";
echo "                  \e[1;34m  \______/ \________|\__|  \__|    \__|\r\n";
echo "\e[0m                  ========================================\e[0m\r\n";
echo "                  \e[101m                                        \r\n";
echo "\e[0m                      CLAY SENDER V1.2 - Hotmail Killer\r\n";
echo "                  \e[107m                                        \r\n";
echo "\e[0m                  ========================================\r\n";
echo "\r\n";
...
function Kirim($email, $smtp_acc, $gx_setup)
{
    ...
    if (array_key_exists('AUTH', $e)) {
        ...
        if ($smtp->authenticate($smtpuser, $smtppass)) {
            ...
            if (!$mail->send()) {
                ...
                echo "\e[1;92m[+]\e[0m \e[1;31m";
                echo date('h:i:s A');
                echo "\e[0m \e[1;35m[+] \e[0m Send To :\e[1;32m $email\e[0m | \e[1;95mSend From\e[0m :\e[1;34m $smtpuser\e[0m\n";
            }
            $mail->clearAddresses();
    ...
    if ($file) {
        $ext = preg_split('/\n|\r\n?/', $file);
        echo "                               \e[1;4m_________________________________\e[0m \r\n";
        echo "\e[1;96m=============================[\e[0m \e[1;4mCLAY SENDER READY - HAPPY SPAMMED\e[0m \e[1;96m]==============================\e[0m";
        echo "\r\n";
        echo "\n";
        $smtp_key = 0;
